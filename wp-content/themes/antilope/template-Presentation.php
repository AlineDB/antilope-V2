...
<section class="layout__but">
    ...
    <div class="but__container">
        ...
        <p class="but__conclusion"><?= __('Ses chiffres sont interpellant ! Nos dispositifs permettent de mieux comprendre et mesurer la qualité de l\'air dans nos villes peut importe quel moyen de locomotion on utilise !', 'Aline-db-antilope'); ?></p>
    </div>
</section>
    ...
    <div class="who__container" itemscope itemtype="https://schema.org/Person">
        <div class="who__partner">
            <figure class="who__fig">
                <figcaption class="who__legend"><?= __('L\'<abbr title="Institut Scientifique du Service Public">ISSEP</abbr> est une unité d\'Aministration Publique qui surveille l\'environnement,
                    prévient les risques et nuisances, effectue des recherches scientifique et Laboratoire de Référence pour la Wallonie.', 'Aline-db-antilope'); ?></figcaption>
            ...
            <div class="partner__description">
                <p><span itemprop="name">Fabian Lenartz</span> : <span itemprop="worksfor" ><?= __('Département Qualité de l\'air', 'Aline-db-antilope'); ?></span></p>
                <p><span itemprop="name">Guy Gerard</span> : <span itemprop="jobTitle"><?= __('Responsable', 'Aline-db-antilope'); ?></span>, <span itemprop="worksfor" ><?= __('Département Qualité de l\'air', 'Aline-db-antilope'); ?></span></p>
            </div>
            <a target="_blank" title="Aller sur le site de l'ISSEP" class="who__link" href="https://www.issep.be" itemprop="url"><?= __('Site de l', 'Aline-db-antilope'); ?> <abbr title="Institut Scientifique du Service Public">ISSEP</abbr></a>
        </div>
        <div class="who__partner">
            <figure class="who__fig">
                <figcaption class="who__legend" ><?= __('Le service électronique de la <abbr title="Haute Ecole de la Province de Liège">HEPL</abbr>', 'Aline-db-antilope'); ?></figcaption>
            ...
            <div class="partner__description">
                <p><span itemprop="name">Valery Broun, Sylvain Gichaux et Christophe Brose</span> : <span itemprop="jobTitle"><?= __('Ingénieurs', 'Aline-db-antilope'); ?></span>, <span itemprop="worksfor" > <abbr title="Haute Ecole de la Province de Liège">HEPL</abbr> <?= __('(Service électronique & systèmes embarqué, Département Ingénieur)', 'Aline-db-antilope'); ?></span></p>
            </div>
            <a target="_blank" title="Aller sur le site du service électronique de la HEPL" class="who__link" href="https://hepl-electro.wixsite.com/index" itemprop="url"><?= __('Site du service électronique', 'Aline-db-antilope'); ?></a>
        </div>
        <div class="who__partner">
            <figure class="who__fig">
                <figcaption class="who__legend"><?= __('La <abbr title="Haute Ecole de la Province de Liège">HEPL</abbr> et le cursus ingénierie', 'Aline-db-antilope'); ?></figcaption>
            ...
            <a target="_blank" title="Aller sur le site de la HEPL" class="who__link" href="https://www.hepl.be/fr/master-ingenieur-industriel" itemprop="url"><?= __('Site de la', 'Aline-db-antilope'); ?> <abbr title="Haute Ecole de la Province de Liège">HEPL</abbr> : <?= __('Master Ingénieurs', 'Aline-db-antilope'); ?></a>
        </div>
    </div>
