            ...
            <form action="<?= get_home_url();  ?>/wp-admin/admin-post.php/" method="post" class="contact__form" >
                ...
                <div class="form__field">
                    <label for="rules" class="form__checkbox">
                        ...
                        <span><?= str_replace(':conditions', '<a title="Voir la page des mentions légales" href="https://antilope.aline-db.be/fr/politique-de-confidentialite/">' . __('conditions générales d\'utilisation', 'Aline-db-antilope') . '</a>', __('J\'accepte les :conditions', 'Aline-db-antilope')); ?>
                        .</span>
                    </label>
                </div>
